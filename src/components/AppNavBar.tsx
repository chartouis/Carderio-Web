    ...
    <div className="absolute top-0 left-0 w-full mnavbar border-b border-cyan-400">
      <nav className="flex flex-nowrap items-center justify-evenly px-4 py-3">
        <div className="flex items-center gap-5">
          <Link className="border border-cyan-400 p-1 m-1 rounded text-cyan-400 hover:bg-cyan-400 hover:text-cyan-800" to="/">
            <div className="">
        ...
        <div className="flex flex-row items-center mx-auto ">
          <Link
            className="nav-link border border-cyan-400 p-1 m-1 rounded text-cyan-400 hover:bg-cyan-400 hover:text-cyan-800" 
            to="/create"
          >
        ...
        <div
          className="border border-cyan-400 p-1 rounded text-cyan-400 hover:bg-cyan-400 hover:text-cyan-800"
