...
export default function LoginForm() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4 bg-[#0D1321] text-white">
      ...
      <form
        className="p-6 border rounded border-white w-full max-w-md"
        onSubmit={submit}
      >
        <div className="mb-4">
          <input
        ...
        <div className="flex justify-between">
          <button
            className="bg-transparent border border-white text-white hover:bg-white hover:text-gray-800 py-2 px-4 rounded"
            type="submit"
          >
            Log in
          </button>
          <Link
            to="/signup"
            className="bg-transparent border border-gray-400 text-gray-400 hover:bg-white hover:text-gray-800 py-2 px-4 rounded"
          >
            Sign Up
          </Link>
        </div>
